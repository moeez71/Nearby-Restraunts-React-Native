...
const Map = () => {
    ...
    const url = `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${currentPosition.latitude},${currentPosition.longitude}&radius=3000&type=restaurant&keyword=hotel&key=AIzaSyAPygMIBKVDTFCt6_f0oLxdvJe7gr7CKfU`
